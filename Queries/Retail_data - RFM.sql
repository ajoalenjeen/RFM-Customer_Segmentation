...
Key takeaway: Champions (12.9% of customers) generate 57.2%
of all revenue — extreme concentration. Combined with Loyal
Customers, just 26% of customers drive 72.4% of revenue.

Meanwhile, Lost (672) and About to Sleep (303) together make
up 22.5% of customers but contribute only 3.5% of revenue.

Priority actions:
- Protect Champions and Loyal Customers at all costs
- Convert New Customers (861, largest segment) into Loyalists
- Re-engage "Cannot Lose Them" (31 high-value churning customers)
