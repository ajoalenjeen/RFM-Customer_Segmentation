...
-- Convert raw metrics into scores (1–5)
...
Key takeaway: Champions (11.4% of customers) generate 55.67%
of all revenue — extreme concentration. Combined with Loyal
Customers, just 24.7% of customers drive 72.3% of revenue.

Meanwhile, Lost (618) and About to Sleep (327) together make
up 22.7% of customers but contribute only 4.1% of revenue.

Priority actions:
- Protect Champions and Loyal Customers at all costs
- Convert New Customers (933, largest segment) into Loyalists
- Re-engage "Cannot Lose Them" (17 high-value churning customers)
- "At Risk" and "Big Spenders at Risk" need urgent win-back
  campaigns — small groups with outsized revenue potential
